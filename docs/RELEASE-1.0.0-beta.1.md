# Hermes × RyzeAPI v1.0.0-beta.1

**Public beta — not stable 1.0.0.**
...
- Both bundled skill versions match the plugin/dashboard: 1.0.0-beta.1.
- This is a documentation/packaging update; pending runtime features remain pending. The earlier v0.14.0-beta.1 release is preserved.
...
- Plugin, painel e duas skills identificados como 1.0.0-beta.1.
- Atualização de documentação/empacotamento: recursos pendentes continuam pendentes. A release v0.14.0-beta.1 foi preservada.
